...
❯ GOOD, It's a nice start, but MANY elements can be animated at the same ti
  elements                                                                 
  Also should check their styling info too, you know skewX/skewY values, ro
  baby steps                                                                                       
  You keep my idea but start with a simple implementation, what do you thin
*/
